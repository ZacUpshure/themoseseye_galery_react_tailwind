...
const projects = [
    {
      ...
      color: 'Black',
      price: '$35',
      href: 'https://www.themoseseye.com/products/item/react-landing-page',
    ...
    },
    {
      ...
      color: 'Black',
      price: '$35',
      href: 'https://www.themoseseye.com/products/item/corporate-identity-design',
...

    {
      ...
      color: 'Black',
      price: '$35',
      href: 'https://www.themoseseye.com/products/item/photo-shooting-basic',
      ...
      },
    {
      ...
      },
      {
        ...
        color: 'Black',
        price: '$35',
        href: 'https://www.themoseseye.com/products/item/photo-shooting-essential',
      ...
      },
      {
        ...
        color: 'Black',
        price: '$35',
        href: 'https://www.themoseseye.com/products/item/photo-shooting-premium',
...
const ImageView = () => {
  ...
  return (
    <div>
        <ModalContent id={project.id} name={project.name} imageSrc={project.imageSrc} imageAlt={project.imageAlt} description={project.description} href={project.href}/>
    </div>
  );
};
